  ...
  sources: [
    {
      ...
      url: "https://bg.battletech.com/forums/index.php?topic=86040.msg2033563#msg2033563",
    },
  ],
  owner: "(NPC)",
  description: [
    ...
    "Militia - Varangian Guard, Morskiye Eskadril {naval squadrons}, Merchant Marines, Beregovaya Okhrana {coast guard}",
    "Associatd Families: Bjork, Blom, Engberg, Hagebak, Jensen, Ruud, Nadezhda, Pasternak, Utkin, Alekseev, Fyodorov, Inoue, Kimura, Bellomo",
  ],
  people: [
    {
      name: "Jahan Tikhonovich",
      title: "Delm",
    },
    {
      name: "Nadzieja Tikhonovich",
      title: "Zokucho/Matrona",
    },
    {
      name: "Samyon Tikhonovich",
      title: "Founder MP",
    },
    {
      name: "Yulian Tikhonovich",
      title: "Founder MP",
    },
    {
      name: "Danya Tikhonovich",
      title: "Spokesperson",
    },
    {
      name: "Eduard Tikhonovich",
      title: "Varangian Guard Commander",
    },
    {
      name: "Larisa Nadezhda",
      title: "Morskiye Eskadril Commander",
    },
    {
      name: "Malia Blom",
      title: "Merchant Marines Commander",
    },
    {
      name: "Viktor Kimura",
      title: "Beregovaya Okhrana Commander",
    },
  ],
  territorialHoldings: [
    {
      name: "The Kola Peninsula",
      location: "Tairiku Continent, Nejiro - Northeast",
    },
    {
      name: "Tikhonovich Fortress",
      size: "2017 sq km",
      location: "West of Leyte, near the center of the Kola Peninsula",
      description: ["small port, rail station, and canals"],
    },
    {
      name: "Leyte",
      location: "Near the southern point of the Kola Peninsula",
      description: [
        "Second oldest Chartered City on Nejiro (after the capitol of Yousai)",
        "Warm subtropical climate",
        "Near the southern point of the Kola Peninsula",
        "Largest city by population with over six million residents",
        "the city was chartered for heavy industry, and is walled and moated in sections to assist in keeping heavy industrial processes contained - refineries, mills, plants, factories, energy plants; and as a transport nexus and home to the largest railroad hub on the planet, an intercontinental aeroport, a regional aeroport, several seaports {commercial, fishing, leisure, military}",
        "an NDT Military Rail Depot, Air Station, and Naval Station, a canal system, and several bridges and tunnels across the Azov Bay and Subarashi Bay to Bridges, Civitas, the Spaceport, the Enclave, Yousai, and the NDT Citadel, Leyte is the origin of the Tollway system",
      ],
    },
  ],
  corporateHoldings: [
    {
      name: "Drake Consortium",
      holdings: [
        {
          name: "Drakon'yego Klada",
          description: [
            "{dragon hoard}",
            "Hedge funds and investments of the Tikhonovich Dai Ichizoku and select clients",
          ],
          locations: [],
        },
        {
          name: "Tikhonovich Estate Farms",
          description: [
            "Sheep, pigs, cattle, goats, poultry, rice, potatoes, thoroughbreds, grains, fruits, greens, wineries, breweries, table vegetables, orchards, forestry, dairy",
          ],
          locations: [],
        },
        {
          name: "Himawari Station",
          description: [
            "{sunflower}",
            "Runs hundreds of head of sheep for wool, meat, leather, sheepskin; also domesticated akashika {red deer} for venison, antlers, leather, velvet, hair, and bones",
          ],
          locations: [],
        },
        {
          name: "Bellomo Artigiano",
          description: ["Creates artisan leather and sheepskin goods"],
          locations: [],
        },
        {
          name: "Dynamo",
          description: [
            "Designs and manufactures industrial robots, equipment, machinery, tools, manufactures industrial mechs and exosuits",
          ],
          locations: [],
        },
        {
          name: "Wassail",
          description: [
            "Produces apples and apple products; white and black hard cider, sweet sparkling cider, unfiltered apple juice, vinegar, butter, sauces, sparkling and flat wines, applejack, apple brandy, and mixed fruit beverages",
          ],
          locations: [],
        },
        {
          name: "Southern Cross Motor Group",
          description: [
            "Manufacture and retail sales of semi-trucks, tractor trailers, military vehicles, combat vehicles, tankers, construction vehicles and equipment, emergency and law enforcement vehicles and equipment, buses, recreational vehicles, IIdelivery trucks, utility trucks",
          ],
          locations: [],
        },
        {
          ...
          description: [
            "{optical systems}",
            "Designs, engineers, and manufactures laser systems (sensors, targeting, radar, communication, lidar), laser weapons (laser, ppc) for vehicles and infantry, holographic weapon sights, holographic media and communication systems, laser small arms, telescopes, binoculars, night vision systems, combat camera systems, military tri-d systems, holosuites, industrial lasers, agricultural laser systems, scientific laser systems, optoelectronics, heat sinks, heat energy converters",
          ],
          locations: [],
        },
        {
          name: "Paladin Core Systems",
          description: [
            "Cutting edge materials and computer engineering firm that designs customizable hexcore operating systems for military, government, and industrial clients",
        ...
        {
          name: "Viking Raider PMC",
          description: [
            "(partnered with the Varangian Guard)",
            "Amphibious marine infantry and space infantry special operations units that specialize in direct action, operating behind the lines, guerilla warfare, unconventional warfare, special reconnaissance, and force reconnaissance that accepts stellar system and Periphery contracts",
          ],
          locations: [],
        },
        {
        ...
        },
        {
          ...
          description: [
            "{dragon sun mills}",
            "Quartz millstone producer of 400 different milled grain products, also packages diverse whole grain foods, baking mixes and ingredients, beans, seeds, nuts, meals, granola, dried fruit, and nutrition boosters",
          ],
          locations: [],
        },
        {
          name: "Horizon Tradeships (est 2309)",
          description: [
            "Interstellar freight transportation to the Izar Cluster, the Periphery, the Draconis Combine, and other locations throughout the Sphere, in partnership with Phoenix Mercantile and Neptune Orient Lines since 2404",
          ],
          locations: [],
        },
        {
          name: "The Endless Boundless",
          description: [
            "Stellar cartographer and stellar survey and exploration via jumpship [tbd] with support from dropships [tbd], space marines, science, and engineering",
          ],
          locations: [],
        },
        {
          ...
          description: [
            "{dragon sun mills}",
            "Field crop, vertical farm, and greenhouse production of dozens of varieties of sunflowers, and factory preparation of ornamental flowers, seeds, meal, flour, milk, oils, butters, lubricants, soaps, detergents, biofuel, and industrial applications",
          ],
          locations: [],
        },
        {
          name: "Drakon Mining Interests",
          description: [
            "Research, exploration, and retrieval of global and stellar sourced ferrous and non-ferrous metals, minerals, gemstones, salt, clay, and chalk",
          ],
          locations: [],
        },
        {
        ...
        {
          name: "Strekoza Plastics",
          description: [
            "{dragonfly}",
            "Processing, design, development, and manufacture of epoxies and elastomers, bioplastics, industrial plastics, consumer plastics, and medical plastics",
          ],
          locations: [],
        },
        {
          name: "Vanguard",
          description: [
            "Global and stellar warehousing, logistics, transport, and distribution services",
          ],
          locations: [],
        },
        {
          name: "Sunshine Roofs",
          description: [
            "Designs, manufactures, and installs fifty year photovoltaic roof shingles, roof systems, and electric storage and power systems for residential, commercial, and government clients",
          ],
          locations: [],
        },
        {
          name: "Strongwell",
          description: [
            "Manufacture of metal and/or composite structural plates and shapes for commercial, industrial, and military use, and also composite military grade armor fabrication for vehicles, buildings, equipment, and personnel",
          ],
          locations: [],
        },
        {
          name: "Dream Lifter Aviation",
          description: [
            "Design, engineering, and manufacture of military and commercial cargo lifters, cargo aircraft, air freighters, aerobatic aircraft, light passenger aircraft, airships, and small craft (mostly cargo carriers or racing yachts)",
          ],
          locations: [],
        },
        {
          ...
          description: [
            "Commercial package and freight transport by train, water, or truck across Tairiku and Nejiro, with stellar system special delivery services",
          ],
          locations: [],
        },
        {
          ...
          description: [
            "{location, trade fair}",
            "Convention center and exhibition hall complex in Leyte",
          ],
          locations: [],
        },
        {
          name: "Monoshiri",
          description: [
            "{curiosity, eagerness to hear}",
            "Designs and manufactures communication equipment (fiber optics, antennae, satellites, switches, mobile devices, transistors, tranceiver stations, semiconductors, routers, amplifiers, receivers, microprocessors, memory chips, multiplexors, telecommunication circuits, augmented virtual technology, tri-d and holographic systems)",
          ],
          locations: [],
        },
        {
          name: "Saryk Atov Ctakah",
          description: [
            "{hawks island glass}",
            "Supplier of custom glass fabrications for professionals in the aerospace, technology, industrial, architectural, and lighting industries",
          ],
          locations: [],
        },
        {
          name: "Polyarnaya Zvezda Recycling",
          description: [
            "{north star}",
            "Zero landfill waste management for commercial, residential, industrial, and government facilities in Yousai, Leyte, the Kola Peninsula, and the Kuroi Oka {black hills} on Tairiku, Nejiro",
          ],
          locations: [],
        },
        {
          name: "PetroChem",
          description: [
            "Fossil, biofuel, and green energy exploration, retrieval, research, infrastructure and production of industrial chemicals, plastics, and energy utility",
          ],
          locations: [],
        },
        {
          name: "Damon Shipyards",
          description: [
            "Inland and blue sea producers of dredging equipment, floating dry docks, offshore vessels, pontoons, tugs and workboats, navy vessels, patrol boats, interceptor and rigid hulls, sea and river cruising vessels, emergency vessels, cargo vessels, tankers, fishing boats, sea factories, yachts, ballast water treatment, repair and conversion, maintenance and resupply, research and development, marine architecture and engineering",
          ],
          locations: [],
        },
        {
          name: "Zheleznyye Dorogi",
          description: [
            "{spirit railways}",
            "Manufactures track, engines, freight cars and coaches; maintains and repairs track and equipment, yards and stations; operates shinkansen, maglev, monorail, and light rail systems across Nejiro and several stellar locations",
          ],
          locations: [],
        },
        {
        ...
        },
        {
          ...
          description: [
            ...
            "Designs and manufactures electric high power high speed locomotives and rolling stock",
          ],
          locations: [],
        },
        {
          ...
          description: [
            "{heavy arms}",
            "Manufacturer of artillery, combat vehicles, field guns, autocannons, machine guns, rockets, explosive ordnance, missiles, launchers, munitions, mines, grenades, small arms, support weapons, and targeting, sighting, sensor, and navigation systems",
          ],
          locations: [],
        },
        {
          name: "JoJo Industrial",
          description: [
            "Manufactures shipping containers, special containers, interstellar needs containers, specialty and custom containers, and other shipping solutions",
          ],
          locations: [],
        },
        {
        ...
        },
        {
          name: "Kotn",
          description: [
            "Textile mills produce cotton, denim, chambray, linen, elephant skin cotton, twill, canvas, rayon, bamboo silk, cordura, wool, flannel, and performance fabrics and threads",
          ],
          locations: [],
        },
        {
          ...
          description: [
            "{feathers}",
            "Designs and manufactures scientific and medical instruments, precision scientific and medical equipment, machines, apparatus, and tools",
          ],
          locations: [],
        },
        {
          name: "Love Honey",
          description: [
            "Manufactures silicone-based, water-based, and oil-based organic personal lubricants and massage oils, manufactures condoms, manufactures edible flavored and/or colored body dust and body paints",
          ],
          locations: [],
        },
        {
          name: "Blue Lotus Pigma",
          description: [
            "Manufactures ballpoint pens, fountain pens, zero gravity pens, nibs, cartridges, rollerball pens, gel pens, fine-line pens, brush pens, calligraphy pens, chisel nib pens, color inks, charcoal ink, solid paints, solid low temp markers, industrial crayon sticks, mechanical pencils, cedar and juniper graphite pencils, charcoal pencils, carbon pencils, colored pencils, watercolor pencils, grease pencils, erasers",
          ],
          locations: [],
        },
        {
          ...
          description: [
            "{decoy}",
            "Designs and manufactures fishing tackle, fishing rods, fishing reels, fishing line, fishing lures, fishing hooks, fishing sinkers, fishing floats, fishing nets, fishing traps, fishing spears, fishing gaffs, fishing waders, fishing gloves, fishing hats, fishing bags, fishing boxes, fishing tools, fishing accessories",
          ],
          locations: [],
        },
        {
          ...
          description: [
            "{evergreen shipping}",
            "container freight and cargo shipping via space, water, air, rail, and truck across Nejiro and the stellar system",
          ],
          locations: [],
        },
        {
          name: "Yasugi Metals",
          description: [
            "produces iron, produces white, blue, and yellow steel, and high performance materials for military, industrial, and aeronautics markets, has a strong research and development branch; produces tatara steel for high end blacksmiths, cutlery, nihonto, and personal weapons",
          ],
          locations: [],
        },
        {
          ...
          description: [
            ...
            "designs and manufactures helmets, safety goggles and visors, filter masks and respirators, gloves, pads, belts, support gear, detectors and alarms, fire suppression and extinguishers, safety glasses, hazardous material and environment apparel and gear, disposable clothing and gear, hard hats, safety harnesses, rainwear, foot protection, cooling and warming products, first aid supplies, hearing protection ",
          ],
          locations: [],
        },
        {
          ...
          description: [
            "{octagon}",
            "machine tool builders, precision equipment manufacturing ",
          ],
          locations: [],
        },
        {
          name: "Denshi o Ugokasu",
          description: [
            "{moving electrons}",
            "design and manufacture of semiconductor devices, integrated circuits, electronic components (active and passive), heat sinks, fans, computer cooling systems ",
          ],
          locations: [],
        },
        {
          name: "Krayeugol'noye Razvitiye'",
          description: [
        ...
        },
        {
          ...
          description: [
            "chemical engineering, chemical plant design and construction, large scale chemical manufacturing, research and development",
        ...
        {
          name: "Independent Education Labs",
          description: [
            "private boarding school for students as young as eight offering a personally tailored course where exceptional children may move toward secondary or tertiary school courses at an accelerated pace while not being forced into awkward social situations that prebubescents thrust into secondary school would experience, it also accepts 'troubled' students with high aptitudes, located in Starkville a suburb of Leyte",
          ],
          locations: [],
        },
        {
          name: "STEM Polytechnic",
          description: [
            "public school in Leyte sponsored and endowed by the Tikhonovich Dai Ichizoku with as many as thirty thousand secondary through tertiary level students across several urban campuses, a strong partner with the Guilds",
          ],
          locations: [],
        },
        {
          name: "Leyte Mechatronic Laboratory",
          description: ["private applied sciences and math research college"],
          locations: [],
        },
        {
          name: "Nucleo Prisma",
          description: [
            "{prism core}",
            "manufactures concrete, cement, and ferrocrete for wet and dry mixes of pervious concrete, nanocrete, microbial concrete, and polymer concrete",
          ],
          locations: [],
        },
        {
        ...
        },
        {
          name: "Honeyscape",
          description: [
            "large scale garden design and landscape design, construction, and maintenance for estates, commercial projects, residential projects, industrial parks, cities, parks",
          ],
          locations: [],
        },
        {
          name: "Maserati Nejiro",
          description: [
