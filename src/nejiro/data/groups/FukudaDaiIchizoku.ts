...
export const FukudaDaiIchizoku: IGroup = {
  ...
  sources: [
    {
      ...
      url: "https://bg.battletech.com/forums/index.php?topic=86040.msg2032846#msg2032846",
    },
  ],
  owner: "(NPC)",
  description: [
  ...
  people: [
    ...
    },
    {
      ...
      job: "Fukuda Defense Force",
    },
    {
      name: "Tison Niiya",
      title: "Militia Commander",
      job: "Fukuda Kawagado {river guard}",
    },
  ],
  territorialHoldings: [
    {
      name: "Fukuda-jo",
      description: [
        "a hirayamajiro and 2071 sq. km landhold near the western banks of the Tone-gawa {raging river} in the foothills of the Kiso Mountains {backbone} at the edges of the Boreal Forest {coniferous snow forest} on the Tairiku continent",
      ],
    },
    {
      name: "Kamloops",
      description: [
        "chartered as a resource city for mining and agriculture in the hilly plains and grasslands near the center of the Southern Steppe region of the Tairiku continent south of the Kiso Mountains",
      ],
    },
    {
      name: "Mauna Kea",
      description: [
        "chartered alpine resort city with light industry near the southern edge of the Kiso Mountains on the Tairiku continent southwest of Whistler and east of the Alpenwylde glaciers",
      ],
    },
    {
      name: "Noboribetsu",
      description: ["chartered hot springs resort northeast of Mauna Kea"],
    },
  ],
  corporateHoldings: [
    {
      ...
      holdings: [
        ...
        {
          name: "Akaibara no Toge",
          description: [
            "{the red roses thorns}",
            "a wakimono {small sword school} of traditionally crafted artisan nihonto (katana, tsurugi, tachi, wakizashi, tanto, naginata, yari, chokuto, {shrine swords}, uchigatana, yajiri, ogatana, kamakura, koto, and kozane {individual scale armor}) and known for the beauty and sharpness of their works",
          ],
        },
        {
          name: "Piastrelle",
        ...
        },
        {
          ...
          description: [
            "{integrated circuit}",
            "a complex that manufactures superconductors and electronic chips",
          ],
        },
        {
          name: "Suisei Hikyaku",
          description: [
            "{mercury courier}",
            "speedy and secure personal courier service (and transporter) for professional, executive, and private clients to global, stellar, and interstellar destinations",
          ],
        },
        {
          name: "Morning Moon Chashitsu",
          description: ["formal tea house chain"],
        },
        {
          name: "Tata Motors",
          description: [
            "manufactures commercial and industrial vehicles and equipment, heavy trucks, super heavy trucks, and military support vehicles",
          ],
        },
        {
          name: "Kikuichi Knife",
          description: [
            "{chrysanthemum straight line}",
            "creates hand hammered hard and soft carbon folded kitchen cutlery, utility knives, combat knives, swords, tools, and accessories for combat and competition, prices begin at three hundred ryu, the factories and workshops are located in Mauna Kea under Mastersmith Sander Caito and his team leaders Arrluk Wada, Isaias Souza, and Jesse Day",
          ],
        },
        {
          name: "Shirukumosu",
          description: [
            "{silk moth}",
            "domesticated samia silk worms produce eri silk textiles for commercial and industrial use",
          ],
        },
        {
          name: "Sant'Antioco",
          description: [
            "bysuss  textile production, spinning, weaving, and dyeing for apparel and home goods",
          ],
        },
        {
          name: "Toraya Confectionary",
          description: ["a traditional maker of wagashi {japanese sweets}"],
        },
        {
          name: "White Oak Joryusho",
          description: [
            "{distillery}",
            "produces whiskey, sake, vodka, and shochu aged as much as one hundred years",
          ],
        },
        {
          name: "Botan Ishiusu",
          description: [
            "{peony millstone}",
            "processes tencha and sencha tea properly for ichiban-cha {first tea} matcha and powdered tea",
          ],
        },
        {
          name: "Botan Cha Noka",
          description: [
            "{peony tea grower}",
            "tea plantation produces several green tea cultivars: yabukita, zhu cha, longjing, maofeng, taiping houkul, and processes several varieties of green tea gyokuro, tencha, sencha, and shincha; the plantation also cultivates peony flowers for tea, traditional medicine, and as a garden flower",
          ],
        },
        {
          name: "Shokunin no Juki Seizo",
          description: [
            "{artisan gunsmiths}",
            "by invitation and referral only gun shop that sells weapons, ammunition, and accessories, that also does 'personal tailoring' and custom builds with locations in Kamloops, Hilo, and the Enclave Market",
          ],
        },
        {
          name: "Nairiku no Zoshensho",
          description: [
            "{inland shipyard}",
            "industrial park on the western banks of the Tone-gawa south of the Fukudo-jo, an inland marine shipyard that builds and services commercial, leisure, law enforcement, safety and emergency, and military vessels; operates passenger and freight transport services",
          ],
        },
        {
          name: "Koun'na Suiden",
          description: [
            "{lucky rice field}",
            "cooperative of rice growers and packers for wholesale",
          ],
        },
        {
          name: "Injigo H2O",
          description: [
            "artesian mineral water bottled in delightful collectible indigo blue glass bottles",
          ],
        },
        {
          name: "Natone",
          description: [
            "creates all natural skincare, hair care, cosmetics, and accessories",
          ],
        },
        {
          name: "Habugaden",
          description: [
            "{herb garden}",
            "three 500 sq meter multilevel climate controlled indoor farms producing fruit, vegetables, herbs, spices, and pharmaceutical flora",
          ],
        },
        {
        ...
        },
        {
          ...
          description: [
            "{riddle}",
            "holds the license to manufacture and create Legos and Knex, also produces puzzles, jigsaw puzzles, coloring books for children and adults, book accessories, book ends, labels, book plates, and bookmarks",
          ],
        },
        {
          name: "Kado-shiki Insatsu",
          description: [
            "{moveable type printing}",
            "printer that produces academic books, magazines, and journals, also fiction paper and hardback novels, woodblock prints, art, and pamphlets",
          ],
        },
        {
          name: "Miss Manners",
        ...
        },
        {
          name: "Brushpainter",
          description: [
            "producer of traditional and modern shuji {calligraphy} and shodo {way of writing} tools and supplies for every style: pens, pencils, paints, markers, chalk, crayons, inks, brushes, inkstones",
          ],
        },
        {
          name: "Studio Peony",
          description: [
            "produces original and manga-based anime features, series, and serials",
          ],
        },
        {
          name: "Huawang",
          description: [
            "{king of flowers}",
            "publishes several magazines and books of manga, comics, graphic novels, fiction, and light novels",
          ],
        },
        {
          name: "Shibori Textiles",
          description: [
            "dyeing cloth with unique designs by binding, stitching, folding, twisting, and/or compressing the fabric; highly refined for cotton and silk apparel, drapery, and household goods",
          ],
        },
        {
          name: "Katazome Textiles",
          description: [
            "hand stenciled and dyed fabrics (cotton, linen, wool, hemp, rayon, silk) for apparel, drapery, household goods",
          ],
        },
        {
          name: "Indigo Dye",
          description: [
            "fabrication of natural dyes from plant fibers and other flora and fauna",
          ],
        },
        {
          name: "Jitensha Kyoyu",
          description: [
            "{bicycle sharing}",
            "electric and manual bicycle rentals in recreational parks, industrial parks, towns, and cities",
          ],
        },
        {
          name: "Hasunohana-ya",
