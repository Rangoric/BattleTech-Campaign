...
export const vohEvents: IEvent[] = [
  ...
  {
    time: "3069 July",
    title: "Kem & Karenth's AIT Training I",
    summary: "Kem & Karenth start their AIT training",
    involvedPeople: ["Kem Icetoff", "Karenth Icetoff"],
    mentionedPeople: [],
    outsideLinks: [
      {
        name: "Forum Post",
        url: "https://bg.battletech.com/forums/index.php?topic=86040.msg2051963#msg2051963",
      },
    ],
    referencePages: [],
    details: [
      ...
      "Kem Icetoff:Well, I am glad I'm not the only one messing up. But that means I did hit something I was supposed to!",
  ...
  },
  {
    ...
    details: [
      ...
      "Jasmine Or'lient:Mostly you will be helping him with the language barrier. He's been doing well, but he's stubborn as hell. Other gearheads can fill in, as needed, while you are dealing with school.",
      ...
      "",
      "Game Effects:",
      "Dahlia is now enrolled in Nejiro Polytech run by Loyalty Forsaken.",
    ],
  },
  {
    time: "3069 July",
  ...
  {
    time: "3069 July",
    title: "Kem & Karenth arrive at MAWS",
    summary: "Kem & Karenth arrive at MAWS for Advanced Infantry Training",
    involvedPeople: ["Kem Icetoff", "Karenth Icetoff", "Damiano Miyabara"],
    mentionedPeople: [],
    outsideLinks: [
      {
        name: "Forum Post",
        url: "https://bg.battletech.com/forums/index.php?topic=86040.msg2034953#msg2034953",
      },
    ],
    referencePages: [],
    details: [
      "Sho-sa Damiano Miyabara will greet Kem Icetoff, Kareth and the crews with them.",
      "Damiano Miyabara: Welcome to MAWS. We have quarters for all of you and space for your vehicle when you are not in the field.",
      "Kem Icetoff: All of us thank you for allowing us to take part in the training program.",
    ],
  },
  {
    time: "3069 July",
  ...
  },
  {
    ...
    referencePages: [],
    details: [
      "Joy let Daisy know that the paperwork will be sent, and Daisy interjected to clarify.",
