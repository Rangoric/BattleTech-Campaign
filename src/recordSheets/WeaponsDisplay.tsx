...
export const WeaponsDisplay: React.FC<IWeaponDisplayProps> = ({ sheet, state }) => {
        ...
        <Table size="small">
          ...
          <TableBody>
            {[
              ...
              <WeaponsDisplayForLocation key={location} location={sheet.unit.locations[location]} state={state} gunnery={gunnery} gunneryGA={gunneryGA} />
            ))}
          </TableBody>
        </Table>
      </TableContainer>
